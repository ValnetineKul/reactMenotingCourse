...
import { OptionType, SelectColor, SelectProps, SelectSize } from 'types';
...
const Select: FC<Props> = ({
  ...
  const NoOptionsMessage = useCallback(
    () => (
      <Text className={styles.noOptionsMessage} align="center" color="black">
        Nothing found
      </Text>
    ),
    [],
  ...
  return (
    <div className={cx(styles.selectWrap, className)}>
      ...
      <div className={cx(styles.selectWithErrorWrap)}>
        <RSelect
          components={{
